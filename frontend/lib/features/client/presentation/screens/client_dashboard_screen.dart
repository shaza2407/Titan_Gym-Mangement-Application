      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
                    ...
                    children: [
                      ...
                      Text('Monthly Plan',
                          style: TextStyle(
                              fontSize: 18, fontWeight: FontWeight.bold)),
                      SizedBox(height: 4),
                      Text('Expires March 15, 2026 (20 days)',
                          style:
                              TextStyle(color: Colors.grey, fontSize: 12)),
                    ],
                  ),
            ...
            // ── Stats Row ─────────────────────────────────────────
            Row(children: [
              _buildStatCard(Icons.trending_up, '4/7', 'Days This\nWeek',
                  const Color(0xFF4CAF50)),
              const SizedBox(width: 12),
              _buildStatCard(Icons.emoji_events_outlined, '12 days',
                  'Current Streak', const Color(0xFFFF9800)),
              const SizedBox(width: 12),
              _buildStatCard(Icons.qr_code, '78', 'Total Visits',
            ...
            Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  const Text('Weekly Attendance Goal',
                      style: TextStyle(
              ...
              child: Column(
                ...
                children: [
                  const Text('Quick Actions',
                      style: TextStyle(
                          fontSize: 16, fontWeight: FontWeight.bold)),
                  const Text('Access your fitness features',
                      style:
                          TextStyle(color: Colors.grey, fontSize: 13)),
                  const SizedBox(height: 16),
                  _buildActionItem(Icons.qr_code_scanner, 'Scan QR Code',
                      'Check in to the gym', () => setState(() => _currentIndex = 2)),
                  _buildActionItem(Icons.notifications_outlined, 'My Gym - Titan Fitness',
                      'View announcements and enroll in classes', () {}),
                  _buildActionItem(Icons.calendar_month_outlined, 'My Schedule',
                      'View and manage your classes', () => setState(() => _currentIndex = 1)),
                  _buildActionItem(Icons.track_changes_outlined, 'Training Plans',
                      'Generate personalized workout plans', () {}),
                  _buildActionItem(Icons.person_outline, 'My Profile',
                      'Update personal information', () => setState(() => _currentIndex = 3)),
                  _buildActionItem(Icons.emoji_events_outlined, 'My Badges',
              ...
              child: Column(
                ...
                children: [
                  const Text('My Achievements',
                      style: TextStyle(
                          fontSize: 16, fontWeight: FontWeight.bold)),
                  const Text('Unlock badges by reaching milestones',
                      style:
                          TextStyle(color: Colors.grey, fontSize: 13)),
                  const SizedBox(height: 16),
                  GridView.count(
