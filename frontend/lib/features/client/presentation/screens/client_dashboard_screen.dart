...
class _ClientDashboardScreenState extends State<ClientDashboardScreen> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildActionItem(
                      ...
                      () {}),
                  _buildActionItem(Icons.track_changes_outlined,
                      'Training Plans', 'Generate personalized workout plans',
                      () {}),
  ...
  Widget _buildSubscriptionCard(DashboardStatsModel stats) {
    ...
    final badgeText   = isActive ? 'Active' : isExpired ? 'Expired' : 'Suspended';
