                  ...
                  Padding(
                    ...
                    child: SizedBox(
                      ...
                      child: ElevatedButton.icon(
                        onPressed: () => Navigator.push(context,MaterialPageRoute(builder: (_) => ChangeNotifierProvider.value(
                            value: controller,
                            ...
                            : controller.gyms.isEmpty
                                ...
                                : ListView.builder(
                                    ...
                                    itemBuilder: (context, index) {
                                      return _buildGymCard(controller.gyms[index]);
                                    },
                                  ),
                  ),
                ],
        ...
        children: [
          ...
          Row(
            children: [
              ...
              Text(gym.location, style: const TextStyle(color: Colors.grey, fontSize: 13)),
            ],
          ),
          ...
          Row(
            children: [
              ...
              const SizedBox(width: 4),
              Text(gym.gymType, style: const TextStyle(color: Colors.grey, fontSize: 13)),
              const Spacer(),
              Text(
                '\$${gym.subscriptionPrice.toStringAsFixed(0)}/mo',
